...
import (
	...
	"github.com/muku314115/go-eth/crypto/signify"
	"github.com/muku314115/go-eth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/muku314115/go-eth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/muku314115/go-eth/internal/version.gitDate="+env.Date)
	}
